...
import { setTrue ,toggleState, setFalse} from "@/lib/features/sidebar/toggleSlice";
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div>
          <p className="text-white">State is {isActive ? 'True' : 'False'}</p>
          <button className="bg-meta-3 px-10 py-4 text-center font-medium text-white w-50" onClick={() => dispatch(toggleState())}>
            Toggle State
          </button>
          <button className="bg-primary px-10 py-4 text-center font-medium text-white" onClick={() => dispatch(setTrue())}>Set True</button>
          <button className="bg-primary px-10 py-4 text-center font-medium text-white" onClick={() => dispatch(setFalse())}>Set False</button>
        </div>
          {/* <!-- Sidebar Menu --> */}
